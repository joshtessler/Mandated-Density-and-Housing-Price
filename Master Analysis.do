...
gen event_time = year - treatment_year + 5
keep if event_time >= -5 & event_time <= 5
drop if missing(treatment_year)
drop treatment_year event_time
 
eststo p1: reg hpi laghpi housing ahousing office commercial commute density income white black indian asian hawaiian tworace twomore inter1 if past == 1, robust
eststo p2: reg hpi laghpi housing ahousing office commercial commute density income white black indian asian hawaiian tworace twomore inter2 if disnear == 1, robust

xtset tractid
eststo p3: xtreg hpi laghpi housing ahousing office commercial commute density income white black indian asian hawaiian tworace twomore inter1 if past == 1, fe robust
eststo p4: xtreg hpi laghpi housing ahousing office commercial commute density income white black indian asian hawaiian tworace twomore inter2 if disnear == 1, fe robust

xtset year
eststo p5: xtreg hpi laghpi housing ahousing office commercial commute density income white black indian asian hawaiian tworace twomore inter1 if past == 1, fe robust
eststo p6: xtreg hpi laghpi housing ahousing office commercial commute density income white black indian asian hawaiian tworace twomore inter2 if disnear == 1, fe robust

xtset tractid year
eststo p7: xtreg hpi laghpi housing ahousing office commercial commute density income white black indian asian hawaiian tworace twomore inter1 if past == 1, fe robust
eststo p8: xtreg hpi laghpi housing ahousing office commercial commute density income white black indian asian hawaiian tworace twomore inter2 if disnear == 1, fe robust
...
*Pretrend Table
esttab p1 p2 p3 p4 p5 p6 p7 p8 using "pretrends", rtf se label stats(tracts r2 r2_a,label("Obs" "R Squared" "Adjusted R Squared")) replace
